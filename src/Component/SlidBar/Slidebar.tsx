...
import imagehy from '../../image/hy.jpg'
export const  Slidebar:FunctionComponent<Icorlor>=({theme,setTheme})=> {
  return (
    <div className={`flex flex-col  h-full bg-white dark:bg-gray-900 justify-center dark:shadow-custom-light items-center p-5  py-5`}>
       <img src={imagehy} alt='user avarta'
       ...
       <div className='flex gap-10 mb-5'>
        ...
        <a href='https://www.facebook.com/giahy.nguyen.1671?mibextid=LQQJ4d'> <AiOutlineFacebook size={23 } className='text-green-600' /></a> 
